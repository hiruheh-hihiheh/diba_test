...
const JOB_TYPE = "with_material" as const;
const TYPE_LABEL = "With Material";
...
export default function JobsWithMaterialPage() {
  ...
  const filteredFolders = useMemo(() => {
    const relevant = folders.filter(f => 
      ...
      ((f.folder_type === "general" || f.folder_type == null) && (f.withMaterialCount ?? 0) > 0)
    );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {monthFolders.map(folder => (
                  ...
                  >
                    ...
                    <p className="text-xs font-semibold text-primary mb-1">{folder.withMaterialCount} {TYPE_LABEL} Jobs</p>
